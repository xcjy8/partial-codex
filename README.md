...
[![CI](https://github.com/xcjy8/partial-codex/actions/workflows/ci.yml/badge.svg)](https://github.com/xcjy8/partial-codex/actions/workflows/ci.yml)
...
- **项目隔离**：每个项目的配置完全独立
- **零全局影响**：不修改 `~/.codex/config.toml`
- **简单易用**：一条命令初始化，一条命令启动
- **灵活配置**：支持自定义 API key、模型、base URL
- **透传参数**：支持 Codex CLI 的所有参数
